...
INSERT INTO ARTISTS(NAME, DESCRIPTION, picture) VALUES ('Fellepo3', 'Fellepo3 leiras', 'fellepo.jpg');

INSERT INTO ARTISTS(NAME, DESCRIPTION, picture) VALUES ('Fellepo4', 'Fellepo4 leiras', 'fellepo2.jpg');

INSERT INTO ARTISTS(NAME, DESCRIPTION, picture) VALUES ('Fellepo5', 'Fellepo5 leiras', 'fellepo3.jpg');

INSERT INTO ARTISTS(NAME, DESCRIPTION, picture) VALUES ('Fellepo6', 'Fellepo6 leiras', 'koncert1.jpg');
...
INSERT INTO FESTIVALS(POSITION_ID, BEGINDATE, ENDDATE, NAME, DESCRIPTION, picture) VALUES ((SELECT id FROM POSITIONS WHERE CITY='Ózd' and DESCRIPTION='FesztivalPos'), '2018-10-23', '2018-11-14', 'ÓzdFest', 'Ózd legjobb fesztiválja', 'feszt.jpg');

INSERT INTO FESTIVALS(POSITION_ID, BEGINDATE, ENDDATE, NAME, DESCRIPTION, picture) VALUES ((SELECT id FROM POSITIONS WHERE CITY='Encs' and DESCRIPTION='FestPos'), '2018-10-11', '2018-10-19', 'EncsFest', 'Encs legjobb fesztiválja', 'feszt2.jpg');
...
INSERT INTO FESTIVALS(POSITION_ID, BEGINDATE, ENDDATE, NAME, DESCRIPTION, picture) VALUES ((SELECT id FROM POSITIONS WHERE CITY='Ukk' and DESCRIPTION='FestPos'), '2019-05-11', '2019-05-14', 'UkkFest', 'Ukk legjobb fesztiválja', 'feszt00.png' );
